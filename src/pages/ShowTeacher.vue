    ...
    <div v-if="teacherData" class="container">
        <div class="d-flex flex-column flex-md-row flex-wrap mt-5">
            ...
            <div class="order-2 order-md-2 order-lg-1 d-flex flex-column gap-3 col-12 col-md-12 col-lg-7 mt-3">
                ...
                <div class="ps-4">
                    <button class="my-btn-container-static btn my-5 py-2 my-rounded my-bgGreen-btn">
                        CONTATTA
                    </button>
                </div>
                <!-- FORM CONTATTA -->
            ...
            <div class="order-1 order-md-1 order-lg-2 col-12 col-md-12 col-lg-5">
                <div class="my-bgGreen my-rounded col-12 col-lg-8 offset-lg-4 mt-3 p-2">
                    <div class="d-flex flex-column align-items-center text-light py-4 gap-3">
                        ...
                        <div class="my-border  d-flex gap-3 bg-light text-dark rounded-pill p-md-3 py-2 px-5 justify-content-around">
                        ...
                        <div class="d-flex text-dark flex-wrap justify-content-center align-items-center gap-2 p-md-3">
                            <template v-for="subject in teacherData.subjects">
                                <div class="my-border subject bg-light py-2 px-3 rounded-pill">{{subject.name}}</div>
                            </template>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="mx-auto d-flex justify-content-center align-items-center">
                    <button class="w-50 my-btn-container btn my-3 fs-5 py-3 position-fixed bottom-0 my-rounded my-bgGreen-btn w-100 text-center">
                        CONTATTA
                    </button>
                </div>
            </div>
